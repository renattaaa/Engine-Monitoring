<template>
  <div class="user-monitoring" v-if="isLogin">
    ...
    <div class="mb-4">
      ...
      <h6 class="ml-7 mt-2 text--secondary">
        Your sleek command center for effortlessly overseeing and managing user
        accounts
      </h6>
    </div>
...
import Table from "@/views/dashboard/User Monitoring/Table.vue";
