<template>
  <div v-if="isLogin">
    ...
    <div class="mb-2">
      <h3 class="ml-7 font-weight-bold" style="color: #356859; margin-top: 5%;">Alert Page</h3>
      <h6 class="ml-7 mt-2 text--secondary">
        Stay on top of your tasks, Easily manage and track your assignments effortlessly
      </h6>
    </div>
...
import Table from "@/views/dashboard/Alert/Table.vue";
